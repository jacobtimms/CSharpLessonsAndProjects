...
namespace PhoneBook.Testing
{
    ...
    public class Test
    {
        ...
        public void TestStoreDoesNotCreateDuplicateNames()
        {
            ...
            // assert
            Assert.Throws<ArgumentException>(() => Phonebook1.Store("Dan", "07791306748"));
            Assert.Throws<ArgumentException>(() => Phonebook1.Store("Dan", "12345678987"));
            Assert.Throws<ArgumentException>(() => Phonebook1.Store("St3v3n", "98765432123"));
        }
